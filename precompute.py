...
# ── Crypto ──
CRYPTO_ASSETS = {"BTCUSD": "BTCUSD"}
PLAUSIBLE_RANGE_CRYPTO = {"BTCUSD": (5_000, 100_000)}
...
ALL_ASSETS = {**FOREX_ASSETS, **METAL_ASSETS, **INDEX_ASSETS, **CRYPTO_ASSETS, **STOCK_ASSETS}
ALL_RANGES = {**PLAUSIBLE_RANGE_FOREX, **PLAUSIBLE_RANGE_METAL, **PLAUSIBLE_RANGE_INDEX, **PLAUSIBLE_RANGE_CRYPTO, **PLAUSIBLE_RANGE_STOCK}
